...
<div id="header">
	...
	include_once('modulos/formVenderAlquilar.php');
	}else{ ?>
          <h1>Necesita acceder a su cuenta para entrar en esta sección. Si no dispone de una puede <a href="#register-box" style="color:#009933" class="register-window">crear una cuenta</a> .</h1>
	<?php } ?>
    </div>
    <div class="clear">&nbsp;</div>
  </div>
