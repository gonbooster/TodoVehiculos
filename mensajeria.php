...
<div id="header">
    ...
    <div class="clear">&nbsp;</div>
    <div id="main-buy">
    	    <center><h1><a href='mensajeria.php?id=0'>Bandeja de Entrada</a> | 
<a href='mensajeria.php?id=1'>Enviados</a></h1></center>
   
	<?php mostrarMensajeria();
	include_once('modulos/formMensajeria.php');?>	
    </div>
    <div class="clear">&nbsp;</div>
  </div>
  <div id="footer">
