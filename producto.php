...
<div id="header">
    ...
    <div id="main-buy">
	<?php
	 include_once('modulos/mostrarProducto.php');?>
	<!--MOSTRAR COMENTARIO-->
	<div class="info"><span><h1>Comentarios</h1></span></div>
	<div id="c_ImprimirComentarios">
	<?php include_once('mostrarComentarios.php'); ?>
	</div>
	<?php if (isset($_SESSION['Email'])){
	include_once('modulos/EscribirComentario.php');
	}else{ ?>
          <h1>Necesita acceder a su cuenta para dejar un comentario. Si no dispone de una puede <a href="#register-box" style="color:#009933" class="register-window">crear una cuenta</a> .</h1>
	<?php } ?>
    </div>
    <div class="clear">&nbsp;</div>
  </div>
